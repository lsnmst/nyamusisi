export default {
    header: {
        text: "Narrative report prepared by the Idjwi-Nyamusisi Nature Reserve Management Committee"
    },
    ...
    history: {
        title: "How a reserve becomes defunct",
        subtitle: "The history of the Nyamusisi Forest Reserve",
        text: `Deforestation in the Nyamusisi Forest Reserve is neither sudden nor accidental. It is the result of a long, cumulative process that is part of regional transformations. The reserve has gradually lost its ecological functions (water regulation, wildlife habitat, soil protection) under the effect of multiple pressures. In addition to demographic pressure due to the influx of refugees caused by armed conflicts in the region, there are other factors common to other case studies in the DRC and on the continent: land insecurity, growing demand for agricultural land due to the food crisis and increased demand for wood energy, and the lack of appropriate governance of the reserve.`
    },

    singes: {
        title: "The last survivors: Schouteden's blue monkeys",
        subtitle: "When the forest disappears, biodiversity takes refuge",
        text: `The Three-Year Operational Plan clearly identifies Schouteden's blue monkeys as the reserve's flagship species. Their current survival, concentrated in extremely small forest fragments, demonstrates both the severity of degradation and the potential for restoration. In Nyamusisi, the disappearance of the forest did not lead to the immediate disappearance of all biodiversity. Some species, such as Schouteden's blue monkeys (<i>Cercopithecus mitis schoutedeni</i>), have survived by retreating to residual forest fragments, less than one hectare in size. These animals are now both survivors and sentinels: their situation reflects the critical state of the ecosystem.`,
        caption: `Image captured by a PEX camera trap at the Bulolero site, Idjwi-Nyamusisi Nature Reserve © Réserve Naturelle d’Idjwi-Nyamusisi`
    },

    three: {
        text: `The habitat of the blue monkeys has been protected with the creation of the Idjwi-Nyamusisi Nature Reserve in 2022. The nature reserve is located on the eastern slopes of the Nyamusisi massif, straddling the chiefdoms of Ntambuka and Rubenga, and is distinguished by its marked altitudinal profile. It is home to an area of caves covering less than one hectare, where a total population of around 100 blue monkeys live.`,
        button: "Discover the interactive model of the Idjwi-Nyamusisi Nature Reserve",
        boxtitle: "Projects approved pending co-financing",
        projects: `♦ Creation of wildlife observation areas<br /> ♦ Training of ecological guides<br /> ♦ Creation of ecological trails<br /> ♦ Familiarizing monkeys with coexisting with humans<br />`
    },

    communa: {
        title: "Giving communities a voice",
        subtitle: "Without community consent, no sustainable restoration",
        text: `Contrary to some preconceived ideas, the communities living in and around the reserve are not opposed to the forest. They are opposed to imposed conservation, which would ignore their vital needs and land rights. In Nyamusisi, ecological restoration is therefore conceived as a process of dialogue and social peace. Restoration means negotiating parcel by parcel. The boundaries of the reserve now run through fields that have been cultivated for more than twenty years in some cases; the solution can therefore be neither expulsion nor the status quo, but a gradual reclassification of land use. The Three-Year Operational Plan devotes an entire pillar to community engagement, recognising that ecological restoration in Nyamusisi is inseparable from the resolution of land and social conflicts. Activities to identify occupants, assess occupied areas and analyse needs form the basis of this process. Recognises and identifies areas of the defunct forest that the community considers restorable and areas that are non-negotiable because they provide their livelihood.`,
        boxtitle: "Projects approved pending co-financing",
        project: `♦ Project to identify occupants and mediate land disputes
          (restore without displacing)<br />
♦ Recognition of alternative activities to intensive exploitation of natural resources and implementation of incentives and compensation measures (revival of abandoned agroforestry systems for coffee and cocoa, and integrated livestock farming)`
    },

    zone: {
        title: "Changing approach: Restoring ≠ excluding",
        subtitle: "The forest no longer conceived as a space to be emptied, but as a space to be organised",
