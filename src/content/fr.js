export default {
    header: {
        text: "Rapport narratif rédigé par le Comité de Gestion de la Réserve Naturelle d'Idjwi-Nyamusisi"
    },
    ...
    history: {
        title: "Comment une réserve devient «défunte»",
        subtitle: "L'histoire de la Réserve forestière de Nyamusisi",
        text: `La déforestation de la Réserve Forestière de Nyamusisi n’est ni soudaine
    ...
    singes: {
        title: "Les derniers survivants : les singes bleus de Schouteden",
        subtitle: "Quand la forêt disparaît, la biodiversité se réfugie",
        text: `Le Plan Opérationnel Triennal identifie clairement les singes bleus de
        ...
        critique de l’écosystème.`,
        caption: `Image capturée par une caméra piège PEX sur le site de Bulolero, Réserve
        Naturelle d’Idjwi-Nyamusisi © Réserve Naturelle d’Idjwi-Nyamusisi`
    },

    three: {
        text: `L'habitat refuge des singes bleus a été protégé avec la création de la
          ...
          singes bleus.`,
        button: "Découvrez la maquette interactive de la réserve naturelle d'Idjwi-Nyamusisi",
    ...
    communa: {
        title: "La parole aux communautés",
        subtitle: "Sans consentement communautaire, pas de restauration durable",
        text: `Contrairement à certaines idées reçues, les communautés vivant dans et
        ...
        project: `♦ Projet d'identification des occupants & médiation foncière
          ...
          café et du cacao, et de l'élevage intégré)`
    },

    zone: {
        title: "Changer d’approche: Restaurer ≠ exclure",
        subtitle: "La forêt plus conçue comme un espace à vider, mais comme un espace à organiser",
        text: `La nouvelle vision de la réserve rompt clairement avec le modèle
        ...
        communauté bénéficie directement de la biodiversité, elle la protège.`,
        boxtitle: "Projets validés dans l'attente d'un cofinancement",
        projects: `♦ Restauration forestière (démarcation des zones, inventaire
          ...
          />`,
        step: "Organisation/zonage de la Réserve Forestière de Nyamusisi"
    },

    agroforesterie: {
        title: "L’agroforesterie comme solution-clé",
        subtitle: "Nourrir les gens tout en nourrissant la forêt. Sécurité alimentaire et diversification économique",
        text: `La relance de l’agroforesterie figure parmi les investissements majeurs
    ...
    femmes: {
        title: "Les femmes au cœur de la restauration",
        subtitle: "Soigner la terre pour sécuriser les familles",
        text: `La restauration écologique de la Réserve Forestière de Nyamusisi passe
    ...
    eco: {
        title: "Forêt, singes bleus et écotourisme",
        subtitle: "Vers l’autonomie de la gestion de la réserve, un modèle économique local et durable",
        text: `L’écotourisme communautaire est envisagé comme un levier économique
    ...
    gestion: {
        title: "La forêt vit si la communauté en vit",
        subtitle: "Gestion communautaire + éducation environnementale",
        text: `La conservation ne se maintient pas uniquement par la surveillance, mais
        ...
        boxtitle: "Projets validés dans l'attente d'un cofinancement",
        projects: `♦ Projet de réseau éducatif autour de la réserve avec les écoles et
          les universités<br />
    ...
    foot: {
        title: "La restauration est déjà en marche. Soutenez la réserve à retrouver son paysage vivant. Contactez-nous",
        text: `La Réserve naturelle d’Idjwi-Nyamusisi a été créée par l’arrêté
